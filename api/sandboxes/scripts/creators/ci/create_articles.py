...
def create_articles(with_capture=False):
    ...
    articles_by_name["Great Barrier"] = Article(
    ...
    articles_by_name["Daily Mail inflates disagreement"] = Article(
        authors="David Rose",
    ...
    articles_by_name["Decline in the amount of dissolved oxygen"] = Article(
    ...
    articles_by_name["Infection bactérienne"] = Article(
    ...
    articles_by_name["Global carbon budget 2014"] = Article(
    ...
    articles_by_name["Fred Poulet"] = Article(
    ...
    ApiHandler.save(*articles_by_name.values())
